...
// APIClient manages communication with the VMware Cloud APIs API v1.0
...
type APIClient struct {
	...
	AccountLinkingApi *AccountLinkingApiService

	AddonsApi *AddonsApiService

	ClustersApi *ClustersApiService

	ConfigStorageApi *ConfigStorageApiService
	...
	EsxApi *EsxApiService

	HcxApi *HcxApiService
	...
	SddcApi *SddcApiService

	SddcNetworksApi *SddcNetworksApiService

	SddcTemplateApi *SddcTemplateApiService
	...
	TbrsApi *TbrsApiService

	TroubleshootingApi *TroubleshootingApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SddcApi = (*SddcApiService)(&c.common)
	c.SddcNetworksApi = (*SddcNetworksApiService)(&c.common)
	c.SddcTemplateApi = (*SddcTemplateApiService)(&c.common)
	...
	c.TbrsApi = (*TbrsApiService)(&c.common)
	c.TroubleshootingApi = (*TroubleshootingApiService)(&c.common)

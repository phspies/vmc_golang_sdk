...
**BackupRestoreBucket** | **string** |  | [optional] [default to null]
**PublicIpPool** | [**[]SddcPublicIp**](SddcPublicIp.md) |  | [optional] [default to null]
**VpcInfo** | [***VpcInfo**](VpcInfo.md) |  | [optional] [default to null]
**KmsVpcEndpoint** | [***KmsVpcEndpoint**](KmsVpcEndpoint.md) |  | [optional] [default to null]
**MaxNumPublicIp** | **int32** | maximum number of public IP that user can allocate. | [optional] [default to null]
**AccountLinkSddcConfig** | [**[]SddcLinkConfig**](SddcLinkConfig.md) |  | [optional] [default to null]
**VsanEncryptionConfig** | [***VsanEncryptionConfig**](VsanEncryptionConfig.md) |  | [optional] [default to null]
**VpcInfoPeeredAgent** | [***VpcInfo**](VpcInfo.md) |  | [optional] [default to null]

...
func (a *TaskApiService) Get(ctx context.Context, org string, localVarOptionals *TaskApiGetOpts) ([]Task, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/orgs/{org}/tasks"
...
/*
TaskApiService Get task details
...
@return Task
*/
func (a *TaskApiService) TaskGet(ctx context.Context, org string, task string) (Task, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/orgs/{org}/tasks/{task}"
	localVarPath = strings.Replace(localVarPath, "{"+"org"+"}", fmt.Sprintf("%v", org), -1)
...
/*
TaskApiService Modify an existing task
 ...
 * @param org Organization identifier.
 * @param task Task identifier
 * @param optional nil or *TaskApiTaskPostOpts - Optional Parameters:
     * @param "Action" (optional.String) -  If &#x3D; &#x27;cancel&#x27;, task will be canceled
@return Task
*/

type TaskApiTaskPostOpts struct {
	Action optional.String
}

func (a *TaskApiService) TaskPost(ctx context.Context, org string, task string, localVarOptionals *TaskApiTaskPostOpts) (Task, *http.Response, error) {
	var (
